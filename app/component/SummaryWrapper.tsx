    ...
    if (editMode) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const newUser: Summary = { ...res, image: res, id: userState.summary.length + 1 };
  ...
  return (
    <div>
      ...
      <Modal isOpen={isModalOpen} toggleModal={toggleModal}>
        {deletemodal === false ? (<> <h2 className="text-center font-bold text-xl">{!editMode ? "Add Content" : "Update Content"}</h2>
          <form
